...
final class BlogController extends AbstractController
{
    ...
    #[Route('/celebrities_list', name: 'celebrities_list', methods: ['GET'])]
    public function celebritiesList(EntityManagerInterface $entityManager): Response
    {
        $celebrities = $entityManager->getRepository(Celebrities::class)->findAll();
        return $this->render('blog/celebrities_list.html.twig', [
